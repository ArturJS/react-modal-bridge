...
- create `.env` file and put it near this `README.md` file

- add `BROWSERSTACK_USERNAME` and `BROWSERSTACK_ACCESS_KEY` with your credentials
...
docker run --env-file .env e2e-tests
```
